...
const AUTH_CONFIG = {
  ...
  JOB_SEEKER_BOT: {
    ...
    CHAT_TITLE: "TopJob AI",
    CHAT_ICON:
      "https://res.cloudinary.com/dtnpj540t/image/upload/v1705727937/my-job/system-images/job-seeker-chatbot-icon.png",
  },
  EMPLOYER_BOT: {
    AGENT_ID: process.env.EMPLOYER_BOT_AGENT_ID || "",
    CHAT_TITLE: "TopJob AI",
    CHAT_ICON:
      "https://res.cloudinary.com/dtnpj540t/image/upload/v1705747491/my-job/system-images/employer-chatbot-icon.png",
  },
};
...
const LINKS = {
  ...
  INSTAGRAM_LINK: "https://www.instagram.com/?hl=vi",
  FACEBOOK_LINK: "https://www.facebook.com/h.n.phong57/",
  FACEBOOK_MESSENGER_LINK: "https://www.facebook.com/h.n.phong57/",
  YOUTUBE_LINK: "https://www.youtube.com/channel/UCNeumOZ-N0z6OgyA3jxCYZQ",
};
