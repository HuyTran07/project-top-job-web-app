    ...
    <Document>
      <Page size="A4" style={styles.body}>
        <View style={{ alignItems: 'center' }}>
          <View>
            <Image
              ...
              src="https://cdn1.vieclam24h.vn/images/default/2024/06/26/Huy%20Tran%20Vieclam24h_171940095144.png"
            />
          </View>
          <View>
            <Text
        ...
        <View style={{ flexDirection: 'row', marginTop: 20 }}>
          <View style={{ flex: 1 }}>
            <Text>Ngày sinh: 19-05-2002</Text>
          </View>
          <View style={{ flex: 1 }}>
            <Text>Email: huytran.1952002@gmail.com</Text>
          </View>
          <View style={{ flex: 1 }}>
        ...
        <View style={{ flexDirection: 'column' }}>
          ...
          <View style={{ marginTop: 20 }}>
            ...
            <View style={{ marginTop: 10 }}>
              <View>
                <Text>09/2023 - 03/2024</Text>
              </View>
              <View>
                <Text>Cong nghe thong tin</Text>
              </View>
              <View>
                <Text>Cử nhân - Đại học Bách Khoa - Đại học Đà Nẵng</Text>
              </View>
              <View style={{ marginTop: 5 }}>
                <Text>
                  Casi todo aquel día caminó sin acontecerle cosa que de contar
          ...
          <View style={{ marginTop: 20 }}>
            ...
            <View style={{ marginTop: 10 }}>
              <View>
                <Text style={{ fontStyle: 'italic' }}>09/2023 - 03/2024</Text>
              </View>
              <View>
                <Text>Cong nghe thong tin</Text>
              </View>
